...
import com.freed.coolweather.gson.Forecast;
import com.freed.coolweather.gson.Weather;
import com.freed.coolweather.service.AutoUpdateService;
...
//        final String weatherId; //下拉刷新bug
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=8bd858f99453458db9484bb4eab72a1d";
